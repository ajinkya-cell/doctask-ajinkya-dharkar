...
class DAOModel(Base):
    ...
    id: Mapped[str] = mapped_column(String(50), primary_key=True)  # e.g. "treehouse-dao"
...
class DocumentModel(Base):
    ...
    dao_id: Mapped[str] = mapped_column(String(50), ForeignKey("daos.id"), nullable=False, default="treehouse-dao", index=True)
...
class ProposalModel(Base):
    ...
    id: Mapped[str] = mapped_column(String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
    dao_id: Mapped[str] = mapped_column(String(50), ForeignKey("daos.id"), nullable=False, default="treehouse-dao", index=True)
    proposal_id: Mapped[str] = mapped_column(String(50), unique=True, nullable=False, index=True)
